...
<head>
  <meta charset="UTF-8">
  <title>백 투 더 퓨처: 한국 현대미술의 동시대성 탐험기</title>
  ...
  <style>
    ...
    .header-container h1.left { float: left; }
    .header-container h1.right { float: right; }
    ...
    .container {
      max-width: 1640px;
      margin: 64px auto 0 auto; /* 헤더와 타이틀 사이 마진 64px로 변경 */
      padding: 0 140px;
  ...
  <script>
    const images = [
      ...
      },
      {
        ...
        audio: "https://video.mmca.go.kr:8888/upload/encoding/audio/2023/06/b55da60a6e9b423eb8776cff15fd163a_media.mp3"
      },
      {
